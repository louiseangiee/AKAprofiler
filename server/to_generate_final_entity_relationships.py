...
csv_file = "/Dataset/entity_pairs_relationship_fortraining.csv"
...
def predict_relationship(entity1, entity2):
    sentence = f"[CLS] [E1] {entity1} [/E1] is the CEO of [E2] {entity2} [/E2]. [SEP]"
    ...
    relation_labels = {0: "No Relation", 1: "Founder_of", 2: "CEO_of"}  # Modify according to your labels
    return relation_labels[predicted_class]
...
data.to_csv("/Dataset/final_entity_relationships.csv", index=False)